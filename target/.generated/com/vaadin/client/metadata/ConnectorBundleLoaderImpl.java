...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Audio","com.vaadin.ui.TextArea","com.vaadin.ui.Slider","com.vaadin.ui.CustomLayout","com.vaadin.ui.TextField","com.vaadin.ui.Table","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.DateField","com.vaadin.ui.Accordion","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.InlineDateField","com.vaadin.ui.Form","com.vaadin.ui.Embedded","com.vaadin.ui.Button","com.vaadin.ui.FormLayout","com.vaadin.ui.Image","com.vaadin.ui.PopupView","com.vaadin.server.FileDownloader","com.vaadin.ui.TabSheet","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Link","com.vaadin.ui.ListSelect","com.vaadin.ui.NativeSelect","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Panel","com.vaadin.ui.TreeTable","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.JavaScript","com.vaadin.ui.PasswordField","com.vaadin.ui.CssLayout","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.ComboBox","com.vaadin.ui.MenuBar","com.vaadin.ui.NativeButton","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Tree","com.vaadin.ui.Label","com.vaadin.ui.CustomField","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Flash","com.vaadin.ui.Window","com.vaadin.ui.Upload","com.vaadin.ui.Video","com.vaadin.ui.GridLayout","com.vaadin.ui.OptionGroup","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.UI","com.vaadin.ui.CheckBox","com.vaadin.ui.CustomComponent","com.vaadin.ui.TwinColSelect",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"id", "caption", "primaryStyleName", "description", "immediate", "registeredEventListeners", "enabled", "errorMessage", "styles", "resources", "width", "readOnly", "height", });
            ...
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"enabled", "errorMessage", "primaryStyleName", "caption", "description", "registeredEventListeners", "resources", "height", "styles", "width", "id", "readOnly", "alternateText", "immediate", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"enabled", "immediate", "readOnly", "callbackNames", "resources", "errorMessage", "height", "width", "rpcInterfaces", "description", "styles", "registeredEventListeners", "id", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"immediate", "id", "styles", "height", "registeredEventListeners", "description", "primaryStyleName", "resources", "width", "errorMessage", "enabled", "readOnly", "alternateText", "caption", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"resolution", "immediate", "hideErrors", "description", "propertyReadOnly", "required", "id", "tabIndex", "enabled", "primaryStyleName", "orientation", "resources", "value", "height", "registeredEventListeners", "errorMessage", "caption", "width", "styles", "readOnly", "maxValue", "minValue", "modified", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"width", "errorMessage", "id", "caption", "readOnly", "description", "styles", "height", "enabled", "immediate", "primaryStyleName", "resources", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"caption", "immediate", "registeredEventListeners", "description", "enabled", "readOnly", "styles", "height", "id", "width", "primaryStyleName", "errorMessage", "resources", "connectorToCssPosition", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"modified", "hideErrors", "description", "id", "resources", "propertyReadOnly", "immediate", "caption", "styles", "width", "tabIndex", "readOnly", "registeredEventListeners", "enabled", "height", "errorMessage", "required", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"readOnly", "registeredEventListeners", "width", "id", "errorMessage", "resources", "description", "marginsBitmask", "height", "styles", "primaryStyleName", "enabled", "spacing", "immediate", "childData", "caption", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "resources", "rpcInterfaces", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"hideErrors", "width", "styles", "primaryStyleName", "registeredEventListeners", "propertyReadOnly", "modified", "id", "required", "height", "immediate", "caption", "enabled", "tabIndex", "description", "resources", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"readOnly", "errorMessage", "styles", "height", "resources", "propertyReadOnly", "hideErrors", "pollingInterval", "primaryStyleName", "caption", "id", "description", "registeredEventListeners", "enabled", "width", "modified", "tabIndex", "immediate", "indeterminate", "state", "required", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"errorMessage", "width", "caption", "description", "registeredEventListeners", "enabled", "embedParams", "primaryStyleName", "height", "id", "codebase", "resources", "archive", "classId", "codetype", "immediate", "styles", "standby", "alternateText", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"description", "enabled", "width", "height", "primaryStyleName", "tabIndex", "readOnly", "caption", "id", "htmlContentAllowed", "clickShortcutKeyCode", "registeredEventListeners", "immediate", "resources", "disableOnClick", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"required", "primaryStyleName", "modified", "immediate", "errorMessage", "resources", "height", "enabled", "id", "propertyReadOnly", "registeredEventListeners", "caption", "styles", "description", "readOnly", "textFieldEnabled", "tabIndex", "width", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"enabled", "registeredEventListeners", "description", "height", "immediate", "styles", "marginsBitmask", "rows", "id", "childData", "width", "primaryStyleName", "spacing", "resources", "readOnly", "caption", "errorMessage", "columns", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row2", "row1", "column1", "alignment", "column2", });
            ...
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollTop", "height", "immediate", "errorMessage", "readOnly", "styles", "scrollLeft", "registeredEventListeners", "enabled", "description", "id", "primaryStyleName", "resources", "tabIndex", "caption", "width", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"names", "resources", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"enabled", "height", "id", "description", "primaryStyleName", "width", "required", "propertyReadOnly", "readOnly", "errorMessage", "immediate", "caption", "registeredEventListeners", "modified", "tabIndex", "styles", "hideErrors", "resources", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"locked", "positionUnit", "position", "positionReversed", "minPosition", "minPositionUnit", "maxPosition", "maxPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"registeredEventListeners", "scrollLeft", "modal", "positionY", "positionX", "description", "styles", "height", "primaryStyleName", "id", "resizable", "centered", "scrollTop", "caption", "draggable", "enabled", "errorMessage", "resizeLazy", "immediate", "resources", "width", "readOnly", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"spacing", "primaryStyleName", "marginsBitmask", "childData", "id", "immediate", "styles", "caption", "width", "readOnly", "description", "resources", "height", "registeredEventListeners", "enabled", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"caption", "resources", "required", "width", "id", "errorMessage", "readOnly", "propertyReadOnly", "description", "immediate", "registeredEventListeners", "enabled", "modified", "hideErrors", "styles", "tabIndex", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"primaryStyleName", "resources", "registeredEventListeners", "width", "id", "errorMessage", "description", "alternateText", "immediate", "styles", "height", "caption", "enabled", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"height", "styles", "errorMessage", "width", "readOnly", "immediate", "caption", "resources", "enabled", "primaryStyleName", "id", "registeredEventListeners", "description", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"required", "resources", "width", "modified", "height", "styles", "primaryStyleName", "description", "enabled", "registeredEventListeners", "propertyReadOnly", "tabIndex", "readOnly", "errorMessage", "caption", "immediate", "id", "hideErrors", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeY", "metaKey", "ctrlKey", "clientX", "altKey", "clientY", "relativeX", "type", "button", "shiftKey", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"description", "enabled", "contentMode", "text", "errorMessage", "width", "registeredEventListeners", "styles", "readOnly", "id", "resources", "immediate", "caption", "height", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"width", "height", "styles", "enabled", "immediate", "readOnly", "registeredEventListeners", "errorMessage", "caption", "description", "resources", "id", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"readOnly", "tabIndex", "immediate", "required", "width", "caption", "resources", "description", "propertyReadOnly", "styles", "registeredEventListeners", "hideErrors", "height", "errorMessage", "enabled", "id", "primaryStyleName", "modified", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"registeredEventListeners", "primaryStyleName", "height", "resources", "required", "styles", "errorMessage", "id", "tabIndex", "width", "immediate", "enabled", "footer", "description", "layout", "hideErrors", "caption", "modified", "propertyReadOnly", "readOnly", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"enabled", "height", "immediate", "primaryStyleName", "styles", "id", "description", "modified", "readOnly", "tabIndex", "width", "caption", "hideErrors", "resources", "required", "errorMessage", "registeredEventListeners", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"childCss", "readOnly", "errorMessage", "styles", "enabled", "registeredEventListeners", "height", "primaryStyleName", "description", "resources", "caption", "width", "immediate", "id", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"errorMessage", "styles", "primaryStyleName", "enabled", "resources", "firstChild", "description", "caption", "secondChild", "readOnly", "immediate", "id", "registeredEventListeners", "height", "splitterState", "width", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"splitterState", "enabled", "secondChild", "resources", "width", "registeredEventListeners", "description", "caption", "styles", "primaryStyleName", "id", "firstChild", "height", "immediate", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"immediate", "hideOnMouseOut", "id", "resources", "styles", "primaryStyleName", "registeredEventListeners", "errorMessage", "height", "enabled", "width", "caption", "description", "html", "readOnly", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"enabled", "propertyReadOnly", "hideErrors", "required", "columns", "height", "immediate", "description", "inputPrompt", "errorMessage", "rows", "modified", "width", "id", "maxLength", "styles", "registeredEventListeners", "text", "primaryStyleName", "wordwrap", "readOnly", "caption", "tabIndex", "resources", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"caption", "autoplay", "resources", "id", "description", "muted", "registeredEventListeners", "errorMessage", "sourceTypes", "height", "showControls", "width", "readOnly", "altText", "htmlContentAllowed", "sources", "enabled", "styles", "immediate", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"childLocations", "resources", "primaryStyleName", "styles", "width", "immediate", "registeredEventListeners", "errorMessage", "description", "templateContents", "templateName", "id", "readOnly", "enabled", "caption", "height", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"errorMessage", "description", "modified", "inputPrompt", "height", "text", "columns", "readOnly", "registeredEventListeners", "styles", "id", "tabIndex", "propertyReadOnly", "width", "resources", "maxLength", "enabled", "required", "caption", "immediate", "primaryStyleName", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"primaryStyleName", "errorMessage", "resources", "clickShortcutKeyCode", "height", "immediate", "enabled", "readOnly", "disableOnClick", "htmlContentAllowed", "registeredEventListeners", "width", "styles", "tabIndex", "description", "caption", "id", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"styles", "height", "registeredEventListeners", "caption", "primaryStyleName", "tabIndex", "immediate", "resources", "enabled", "id", "errorMessage", "description", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"registeredEventListeners", "readOnly", "propertyReadOnly", "primaryStyleName", "tabIndex", "immediate", "required", "description", "height", "caption", "styles", "id", "resources", "width", "enabled", "errorMessage", "modified", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"spacing", "description", "caption", "immediate", "errorMessage", "enabled", "width", "styles", "id", "marginsBitmask", "resources", "height", "registeredEventListeners", "childData", "readOnly", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"resources", "hideErrors", "modified", "primaryStyleName", "immediate", "width", "caption", "description", "propertyReadOnly", "styles", "height", "enabled", "errorMessage", "tabIndex", "id", "required", "registeredEventListeners", "checked", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"uriFragment", "enabled", "resources", "parameters", "caption", "id", "errorMessage", "readOnly", "height", "immediate", "features", "styles", "width", "description", "target", "registeredEventListeners", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"showControls", "sources", "caption", "width", "description", "resources", "styles", "muted", "registeredEventListeners", "errorMessage", "id", "height", "immediate", "primaryStyleName", "altText", "autoplay", "sourceTypes", "readOnly", "enabled", "htmlContentAllowed", });
          ...
          private void load19() {
            ...
            store.setHasGetTooltipInfo(com.vaadin.client.ui.window.WindowConnector.class);
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"styles", "immediate", "enabled", "resources", "width", "caption", "cursorY", "cursorX", "height", "bgColor", "description", "registeredEventListeners", "errorMessage", "id", "primaryStyleName", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"height", "styles", "readOnly", "id", "primaryStyleName", "popupVisible", "color", "showDefaultCaption", "resources", "caption", "description", "errorMessage", "enabled", "registeredEventListeners", "htmlContentAllowed", "immediate", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"changedX", "changedY", "description", "errorMessage", "enabled", "height", "readOnly", "rowCount", "changedColor", "resources", "width", "registeredEventListeners", "id", "immediate", "styles", "primaryStyleName", "caption", "columnCount", });
