...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Audio","com.vaadin.ui.TwinColSelect","com.vaadin.ui.JavaScript","com.vaadin.ui.Upload","com.vaadin.ui.InlineDateField","com.vaadin.ui.NativeButton","com.vaadin.ui.Panel","com.vaadin.ui.OptionGroup","com.vaadin.ui.ProgressIndicator","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.TreeTable","com.vaadin.ui.Image","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.Window","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.PasswordField","com.vaadin.ui.Embedded","com.vaadin.server.FileDownloader","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.Table","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Slider","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.UI","com.vaadin.ui.DateField","com.vaadin.ui.Accordion","com.vaadin.ui.PopupView","com.vaadin.ui.Button","com.vaadin.ui.GridLayout","com.vaadin.ui.TextArea","com.vaadin.ui.CheckBox","com.vaadin.ui.CustomLayout","com.vaadin.ui.VerticalLayout","com.vaadin.ui.CustomField","com.vaadin.ui.TabSheet","com.vaadin.ui.Tree","com.vaadin.ui.CssLayout","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.FormLayout","com.vaadin.ui.ComboBox","com.vaadin.ui.TextField","com.vaadin.ui.ListSelect","com.vaadin.ui.BrowserFrame","com.vaadin.ui.NativeSelect","com.vaadin.ui.Link","com.vaadin.ui.Flash","com.vaadin.ui.CustomComponent","com.vaadin.ui.Video","com.vaadin.ui.MenuBar","com.vaadin.ui.Label","com.vaadin.ui.Form",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"enabled", "marginsBitmask", "errorMessage", "width", "resources", "immediate", "height", "primaryStyleName", "styles", "spacing", "id", "childData", "description", "caption", "readOnly", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"id", "styles", "registeredEventListeners", "height", "callbackNames", "readOnly", "enabled", "caption", "width", "primaryStyleName", "errorMessage", "rpcInterfaces", "description", "resources", "immediate", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"childData", "errorMessage", "spacing", "rows", "id", "caption", "height", "readOnly", "marginsBitmask", "enabled", "columns", "styles", "resources", "primaryStyleName", "width", "description", "immediate", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"width", "registeredEventListeners", "primaryStyleName", "id", "caption", "resources", "modified", "errorMessage", "enabled", "styles", "required", "height", "propertyReadOnly", "hideErrors", "tabIndex", "description", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"primaryStyleName", "styles", "description", "width", "spacing", "resources", "id", "readOnly", "caption", "immediate", "childData", "marginsBitmask", "registeredEventListeners", "height", "errorMessage", "enabled", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"errorMessage", "immediate", "styles", "description", "propertyReadOnly", "height", "required", "readOnly", "caption", "resources", "hideErrors", "primaryStyleName", "enabled", "registeredEventListeners", "id", "width", "modified", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"registeredEventListeners", "height", "description", "id", "hideErrors", "required", "textFieldEnabled", "tabIndex", "readOnly", "errorMessage", "propertyReadOnly", "primaryStyleName", "caption", "styles", "width", "enabled", "modified", "resources", "immediate", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"required", "maxValue", "description", "caption", "id", "value", "minValue", "modified", "styles", "propertyReadOnly", "registeredEventListeners", "resolution", "tabIndex", "primaryStyleName", "hideErrors", "width", "immediate", "errorMessage", "height", "readOnly", "enabled", "resources", "orientation", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"readOnly", "tabIndex", "caption", "errorMessage", "id", "registeredEventListeners", "resources", "primaryStyleName", "height", "description", "required", "styles", "enabled", "modified", "hideErrors", "width", "immediate", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "enabled", "registeredEventListeners", "resources", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"readOnly", "primaryStyleName", "immediate", "registeredEventListeners", "description", "text", "resources", "styles", "contentMode", "width", "caption", "id", "enabled", "errorMessage", "height", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"enabled", "styles", "immediate", "readOnly", "alternateText", "resources", "description", "primaryStyleName", "height", "width", "id", "registeredEventListeners", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"styles", "width", "hideErrors", "primaryStyleName", "modified", "caption", "readOnly", "enabled", "pollingInterval", "errorMessage", "indeterminate", "immediate", "tabIndex", "state", "height", "resources", "registeredEventListeners", "propertyReadOnly", "description", "id", "required", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"width", "registeredEventListeners", "enabled", "description", "immediate", "height", "readOnly", "styles", "id", "caption", "errorMessage", "primaryStyleName", "resources", "tabIndex", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"description", "resources", "width", "primaryStyleName", "id", "autoplay", "sources", "registeredEventListeners", "htmlContentAllowed", "readOnly", "height", "altText", "muted", "sourceTypes", "errorMessage", "immediate", "styles", "showControls", "caption", "enabled", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"tabIndex", "immediate", "primaryStyleName", "required", "registeredEventListeners", "modified", "enabled", "resources", "propertyReadOnly", "height", "width", "styles", "caption", "readOnly", "hideErrors", "id", "description", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"registeredEventListeners", "errorMessage", "marginsBitmask", "caption", "readOnly", "enabled", "height", "childData", "description", "resources", "primaryStyleName", "immediate", "width", "styles", "id", "spacing", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPosition", "maxPositionUnit", "positionUnit", "locked", "positionReversed", "minPositionUnit", "minPosition", "position", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"primaryStyleName", "width", "resources", "hideErrors", "required", "checked", "propertyReadOnly", "id", "enabled", "immediate", "height", "tabIndex", "registeredEventListeners", "modified", "styles", "errorMessage", "readOnly", "description", "caption", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"height", "caption", "styles", "hideErrors", "errorMessage", "immediate", "width", "readOnly", "primaryStyleName", "modified", "propertyReadOnly", "tabIndex", "registeredEventListeners", "id", "description", "enabled", "resources", "required", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"autoplay", "showControls", "width", "immediate", "height", "caption", "primaryStyleName", "registeredEventListeners", "sourceTypes", "description", "id", "htmlContentAllowed", "readOnly", "enabled", "muted", "errorMessage", "resources", "styles", "altText", "sources", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"resources", "enabled", "immediate", "registeredEventListeners", "errorMessage", "features", "target", "uriFragment", "width", "caption", "primaryStyleName", "readOnly", "height", "parameters", "description", "styles", "id", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"enabled", "readOnly", "resources", "primaryStyleName", "styles", "scrollTop", "height", "id", "errorMessage", "tabIndex", "description", "width", "immediate", "registeredEventListeners", "caption", "scrollLeft", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"readOnly", "resources", "styles", "immediate", "columns", "required", "caption", "modified", "text", "inputPrompt", "hideErrors", "id", "width", "description", "registeredEventListeners", "errorMessage", "primaryStyleName", "propertyReadOnly", "maxLength", "height", "enabled", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"description", "alternateText", "width", "errorMessage", "primaryStyleName", "caption", "resources", "registeredEventListeners", "immediate", "id", "styles", "readOnly", "height", "enabled", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"registeredEventListeners", "immediate", "id", "resources", "caption", "primaryStyleName", "styles", "width", "errorMessage", "enabled", "readOnly", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"splitterState", "caption", "height", "enabled", "secondChild", "firstChild", "readOnly", "registeredEventListeners", "id", "immediate", "description", "errorMessage", "width", "styles", "resources", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"immediate", "id", "readOnly", "styles", "enabled", "errorMessage", "tabIndex", "propertyReadOnly", "hideErrors", "registeredEventListeners", "caption", "height", "primaryStyleName", "modified", "required", "resources", "width", "description", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"text", "maxLength", "columns", "immediate", "description", "tabIndex", "height", "primaryStyleName", "hideErrors", "modified", "errorMessage", "id", "propertyReadOnly", "resources", "wordwrap", "registeredEventListeners", "width", "readOnly", "rows", "enabled", "required", "caption", "styles", "inputPrompt", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"styles", "height", "resources", "immediate", "required", "readOnly", "footer", "layout", "modified", "hideErrors", "description", "registeredEventListeners", "primaryStyleName", "id", "caption", "errorMessage", "propertyReadOnly", "width", "enabled", "tabIndex", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"enabled", "resources", "primaryStyleName", "immediate", "registeredEventListeners", "description", "readOnly", "height", "styles", "width", "caption", "errorMessage", "id", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"registeredEventListeners", "required", "enabled", "width", "immediate", "tabIndex", "description", "primaryStyleName", "hideErrors", "readOnly", "propertyReadOnly", "errorMessage", "modified", "id", "styles", "height", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"height", "id", "registeredEventListeners", "caption", "width", "immediate", "errorMessage", "readOnly", "description", "childCss", "enabled", "styles", "primaryStyleName", "resources", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"styles", "enabled", "readOnly", "registeredEventListeners", "id", "errorMessage", "width", "immediate", "caption", "resources", "height", "description", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"type", "relativeY", "clientY", "relativeX", "ctrlKey", "altKey", "button", "clientX", "shiftKey", "metaKey", });
            ...
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"required", "tabIndex", "immediate", "description", "id", "styles", "width", "caption", "hideErrors", "propertyReadOnly", "height", "readOnly", "errorMessage", "primaryStyleName", "resources", "modified", "registeredEventListeners", "enabled", });
            ...
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"description", "primaryStyleName", "styles", "enabled", "registeredEventListeners", "width", "caption", "immediate", "connectorToCssPosition", "resources", "height", "readOnly", "id", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"readOnly", "width", "primaryStyleName", "enabled", "resources", "height", "caption", "immediate", "errorMessage", "styles", "description", "id", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"archive", "standby", "enabled", "styles", "readOnly", "resources", "registeredEventListeners", "codebase", "caption", "classId", "codetype", "height", "alternateText", "width", "errorMessage", "embedParams", "id", "primaryStyleName", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"readOnly", "styles", "immediate", "registeredEventListeners", "id", "description", "caption", "html", "width", "errorMessage", "resources", "hideOnMouseOut", "height", "enabled", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"readOnly", "resizable", "enabled", "registeredEventListeners", "tabIndex", "styles", "height", "modal", "errorMessage", "immediate", "resizeLazy", "caption", "resources", "description", "width", "centered", "positionX", "positionY", "primaryStyleName", "id", "draggable", "scrollLeft", "scrollTop", });
            ...
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"immediate", "id", "height", "caption", "resources", "primaryStyleName", "registeredEventListeners", "width", "alternateText", "styles", "description", "errorMessage", "readOnly", "enabled", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"readOnly", "primaryStyleName", "resources", "templateName", "styles", "id", "errorMessage", "caption", "registeredEventListeners", "templateContents", "description", "width", "childLocations", "immediate", "enabled", "height", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"registeredEventListeners", "immediate", "description", "enabled", "tabIndex", "disableOnClick", "primaryStyleName", "htmlContentAllowed", "styles", "id", "caption", "clickShortcutKeyCode", "readOnly", "height", "errorMessage", "resources", "width", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"caption", "registeredEventListeners", "secondChild", "height", "id", "errorMessage", "splitterState", "styles", "primaryStyleName", "description", "firstChild", "width", "readOnly", "resources", "enabled", "immediate", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"width", "styles", "immediate", "tabIndex", "registeredEventListeners", "clickShortcutKeyCode", "enabled", "disableOnClick", "primaryStyleName", "resources", "errorMessage", "height", "readOnly", "caption", "description", "htmlContentAllowed", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"id", "enabled", "caption", "styles", "resources", "bgColor", "description", "width", "readOnly", "immediate", "errorMessage", "cursorX", "height", "registeredEventListeners", "cursorY", "primaryStyleName", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"width", "registeredEventListeners", "resources", "readOnly", "description", "id", "popupVisible", "htmlContentAllowed", "height", "styles", "color", "immediate", "caption", "showDefaultCaption", "primaryStyleName", "errorMessage", "enabled", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"height", "changedY", "styles", "width", "rowCount", "columnCount", "errorMessage", "resources", "changedX", "readOnly", "caption", "immediate", "changedColor", "registeredEventListeners", "id", "description", "enabled", "primaryStyleName", });
