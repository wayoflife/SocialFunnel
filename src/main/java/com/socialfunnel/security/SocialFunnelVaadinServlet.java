...
@WebServlet(urlPatterns = "/ui", name = "SocialFunnelWebServlet", asyncSupported = true)
@VaadinServletConfiguration(ui = SocialFunnelUI.class, productionMode = false)
public class SocialFunnelVaadinServlet extends SpringVaadinServlet{
	
	public SocialFunnelVaadinServlet() {
		super();
	}
	
}
//public class SocialFunnelVaadinServlet extends SpringAwareVaadinServlet {
//	
//	@Override
